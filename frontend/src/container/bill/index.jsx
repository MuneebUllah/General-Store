...
import AddBillPopup from "../../helpers/models/popups/add-bill";
...
const Bill = () => {
  ...
  useEffect(() => { getBills(setData) } ,[addBillModalIsOpen])
    ...
    return(
      ...
      <div className="flex justify-between items-center mb-6">
        ...
        <button 
          ...
          onClick={() => {         
            dispatch(setAddBillModalIsOpen(true))}} >Add Bill</button>
        </div>
