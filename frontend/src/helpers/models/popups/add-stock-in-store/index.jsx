...
const AddStockInStorePopup = () => {
    ...
    const { postData, getAllCategories, getAllNames, getAllSizes } = useHook();
    ...
    return (
        ...
        >
            ...
            <div className='flex flex-wrap w-full gap-6 mt-6 px-8'>
                ...
                <div className="flex justify-between w-full gap-4">
                    <Searchinput type='number' placeholder='Quantity (Cottons)' value={data?.quantity} onchange={(value) => handleInputChange('quantity', value)} />
                    <Searchinput type='number' placeholder='Price' value={data?.price} onchange={(value) => handleInputChange('price', value)} />
                </div>
                <Searchinput placeholder='Items in a Cotton' type='number' value={data?.noOfItems} onchange={(value) => handleInputChange('noOfItems', value)} />
                <div className="flex justify-between w-full gap-4">
                    <div className="w-1/2">
                        <select
                            id="Size"
                    ...
                    <Searchinput placeholder='Weight (Optional)' value={data?.weight} className='w-1/2' onchange={(value) => handleInputChange('weight', value)} />
                </div>
            </div>
            <div className='mt-6'>
